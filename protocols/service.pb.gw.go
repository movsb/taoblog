...
var (
	filter_TaoBlog_SetPostStatus_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_TaoBlog_SetPostStatus_0(ctx context.Context, marshaler runtime.Marshaler, client TaoBlogClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_TaoBlog_SetPostStatus_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	...
	pattern_TaoBlog_ListComments_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v3", "comments"}, "", runtime.AssumeColonVerbOpt(true)))
