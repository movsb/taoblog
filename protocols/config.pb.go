...
type GetInfoResponse struct {
	...
	CertDaysLeft int32 `protobuf:"varint,11,opt,name=cert_days_left,json=certDaysLeft,proto3" json:"cert_days_left,omitempty"`
	// 域名有效时间剩余天数。大于 >= 0 有效。
	DomainDaysLeft int32 `protobuf:"varint,12,opt,name=domain_days_left,json=domainDaysLeft,proto3" json:"domain_days_left,omitempty"`
}
...
func (x *GetInfoResponse) GetCertDaysLeft() int32 {
	if x != nil {
		return x.CertDaysLeft
	}
	return 0
}

func (x *GetInfoResponse) GetDomainDaysLeft() int32 {
	if x != nil {
		return x.DomainDaysLeft
	}
	return 0
}
...
var file_protocols_config_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xd1, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x49,
	...
	0x61, 0x73, 0x74, 0x50, 0x6f, 0x73, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x24, 0x0a, 0x0e, 0x63,
	0x65, 0x72, 0x74, 0x5f, 0x64, 0x61, 0x79, 0x73, 0x5f, 0x6c, 0x65, 0x66, 0x74, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x0c, 0x63, 0x65, 0x72, 0x74, 0x44, 0x61, 0x79, 0x73, 0x4c, 0x65, 0x66,
	0x74, 0x12, 0x28, 0x0a, 0x10, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x5f, 0x64, 0x61, 0x79, 0x73,
	0x5f, 0x6c, 0x65, 0x66, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x64, 0x6f, 0x6d,
	0x61, 0x69, 0x6e, 0x44, 0x61, 0x79, 0x73, 0x4c, 0x65, 0x66, 0x74, 0x22, 0x28, 0x0a, 0x0e, 0x52,
